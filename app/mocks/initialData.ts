...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    title: "Sweatpants",
    description:
      "Soft and comfortable sweatpants in stylish shades. They are perfect for lounging with their cozy stretch fabric that offers just the right price o warmth. Enjoy the ultimate relaxation experience!",
    image:
